object Dependencies {
    ...
    // Serialization
    const val KOTLIN_X_SERIALIZATION =
        "org.jetbrains.kotlinx:kotlinx-serialization-json:${Version.KOTLIN_X_SERIALIZATION}"
    const val KOTLIN_SERIALIZATION_CONVERTOR =
        "com.jakewharton.retrofit:retrofit2-kotlinx-serialization-converter:${Version.KOTLIN_SERIALIZATION_CONVERTOR}"
